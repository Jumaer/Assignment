package com.periscope.jumaer.ui_support
...
fun setItemTouchHelper(context: Context, recyclerView: RecyclerView, adapter: DetailsItemAdapter) {
    ...
    ItemTouchHelper(object : ItemTouchHelper.Callback() {
        ...
        private fun recoverSwipedItem(
            ...
            for (i in adapter.dataList.size downTo 0) {
...
private fun dipToPx(context: Context): Int {
    return (240f * context.resources.displayMetrics.density).toInt()
}